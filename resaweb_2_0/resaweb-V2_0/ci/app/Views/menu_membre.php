            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        <a class="sidebar-link" href="<?= site_url('compte/dashboard-membre') ?>">
                ...
                <div class="container-fluid p-0">
                    ...
                    <table class="table table-hover my-0 mt-3">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" class="text-center text-muted">Aucune réservation à venir</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                            ...
                            <?php if (!empty($reservations_passees)): ?>
                                <?php foreach ($reservations_passees as $r): ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-md-table-cell"><?= esc($personne) ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
