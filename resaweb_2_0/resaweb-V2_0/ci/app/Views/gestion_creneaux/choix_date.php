        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3"><strong>Créneaux réservés</strong></h1>

                    <div class="card w-50">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Choisissez une date</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= site_url('reservations_jour') ?>">

                                <label class="form-label">Date :</label>
                                <input type="date" name="date" class="form-control" required>

                                <button class="btn btn-primary mt-3">Voir les réservations</button>
                            </form>
