    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 text-center text-md-left">
          <p class="text-light mb-0">Copyright &copy; 2019 a theme by <a class="text-gradient-primary" href="https://themefisher.com">themefisher.com | site fait par Aleksi Loddo</a>
          </p>
        </div>
        <div class="col-md-6">
...
<!-- /footer -->
  ...
  <!-- JS includes -->
  <script src="<?= base_url('bootstrap/source/plugins/jQuery/jquery.min.js') ?>"></script>
  <script src="<?= base_url('bootstrap/source/plugins/bootstrap/bootstrap.min.js') ?>"></script>
  <script src="<?= base_url('bootstrap/source/plugins/slick/slick.min.js') ?>"></script>
  <script src="<?= base_url('bootstrap/source/plugins/venobox/venobox.min.js') ?>"></script>
  <script src="<?= base_url('bootstrap/source/plugins/shuffle/shuffle.min.js') ?>"></script>
  <script src="<?= base_url('bootstrap/source/plugins/card-slider/js/card-slider-min.js') ?>"></script>
  <script src="<?= base_url('bootstrap/source/js/script.js') ?>"></script>
